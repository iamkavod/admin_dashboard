...
if (isset($_POST['submit'])) {
  ...
  $sql = "insert into `admindash` (name, dob, phone_number, bank_account, email_address) values('$name', '$dob', '$phone_number', '$bank_account', '$emailaddress')";
...
<body>
 ...
 <main class="container" id="mainPage">
   ...
   <main class="body__container">
    ...
    <div class="add__customer">
     ...
     <form method="post" >
      ...
      <input type="date" placeholder="Date of Birth" name="dob" autocomplete="off">
      <input type="phone" placeholder="Phone Number" name="phonenumber" autocomplete="off">
      <input type="text" placeholder="Bank Account" name="bankaccount" autocomplete="off">
      <input type="email" placeholder="Email" name="email" autocomplete="off">

      <div class="add__property">
  ...
  <div class="add__customer form-popup" id="update">
     ...
     <form method="post" class="form-container">
      ...
      <button type="submit" class="btn" name="submit" onclick="closeForm()">Cancle</button>
     </form>
    </div>
</div>
  </section>
